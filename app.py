...
def main():
    ...
    with st.sidebar:
        ...
        min_vol = st.number_input("🔻 Taglia minima cliente", 0, 100000, 0, step=100)

        # --- MATRICE CLASSIFICAZIONE ABC (editabile) ---
        st.markdown("**📊 Matrice Classificazione & Frequenze**")
    ...
    if st.session_state.current_result is not None:
        ...
        disp.columns = ['Venditore', 'Stato', 'Clienti', 'A', 'B', 'C', 'Volume',
